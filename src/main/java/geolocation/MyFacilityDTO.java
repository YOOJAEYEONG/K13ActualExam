...
public class MyFacilityDTO {
	...
	public MyFacilityDTO(String hp_name, String hp_sido, String hp_gugun,
			String hp_addr, String hp_url, String hp_latitude,
			String hp_longitude, String disKM, String rNum) {
		super();
